...
export default function Home() {
  ...
  useEffect(()=>{
    async function getListData(){
        const response = await axios.get('https://expenses-database-368b0-default-rtdb.europe-west1.firebasedatabase.app//comments.json')
        return (Object.values(response.d))
    }
  }, [])
